...
$ python3 03_compare_color_matrices.py library_eY2H_384Singleton_NewPlate6.csv proc leyre proc mather p53 diagnostic 6 1 1 1
...
def main():
    ...
    parser.add_argument('datafile', metavar='csv_filename', type=str, help='name of the CSV with reference genes')
    ...
    for gidx in range(len(genes)):
        ...
        for platenum in range(1, args.plate_num+1):
            ...
            if not os.path.isfile(filename):
                ...
                # 2. Outliers are those 2.5 stds away from the mean
                sigmalim=2.5
                ...
                lsignif = get_significant_summary(ltmask, repsr*repsc - repsr)
                ssignif = get_significant_summary(stmask, repsr*repsc - repsr)
